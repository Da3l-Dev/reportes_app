...
declare class alumnosPrioritariosController {
    ...
    getDataSecundariaTecnica(req: Request, res: Response): Promise<Response<any, Record<string, any>> | undefined>;
    getDataTelesecundaria(req: Request, res: Response): Promise<Response<any, Record<string, any>> | undefined>;
}
