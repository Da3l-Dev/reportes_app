...
export declare function dashboardSisatOpEdu(req: Request, res: Response): Promise<void>;
...
export declare function generatedSisatOpEdu(req: Request, res: Response): Promise<Response<any, Record<string, any>>>;
