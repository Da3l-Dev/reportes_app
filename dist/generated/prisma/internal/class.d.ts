 ...
 * `prisma.item_cct`: Exposes CRUD operations for the **item_cct** model.
  ...
  */
    ...
    /**
     * `prisma.primera_exploracion_sisat`: Exposes CRUD operations for the **primera_exploracion_sisat** model.
      * Example usage:
      * ```ts
      * // Fetch zero or more Primera_exploracion_sisats
      * const primera_exploracion_sisats = await prisma.primera_exploracion_sisat.findMany()
      * ```
      */
    get primera_exploracion_sisat(): Prisma.primera_exploracion_sisatDelegate<ExtArgs, {
        omit: OmitOpts;
    }>;
    /**
     * `prisma.segunda_exploracion_sisat`: Exposes CRUD operations for the **segunda_exploracion_sisat** model.
      * Example usage:
      * ```ts
      * // Fetch zero or more Segunda_exploracion_sisats
      * const segunda_exploracion_sisats = await prisma.segunda_exploracion_sisat.findMany()
      * ```
      */
    get segunda_exploracion_sisat(): Prisma.segunda_exploracion_sisatDelegate<ExtArgs, {
        omit: OmitOpts;
    }>;
    /**
     * `prisma.ni_cct`: Exposes CRUD operations for the **ni_cct** model.
      * Example usage:
      * ```ts
      * // Fetch zero or more Ni_ccts
      * const ni_ccts = await prisma.ni_cct.findMany()
      * ```
      */
    get ni_cct(): Prisma.ni_cctDelegate<ExtArgs, {
        omit: OmitOpts;
    }>;
    /**
     * `prisma.tercera_exploracion_sisat`: Exposes CRUD operations for the **tercera_exploracion_sisat** model.
      * Example usage:
      * ```ts
      * // Fetch zero or more Tercera_exploracion_sisats
      * const tercera_exploracion_sisats = await prisma.tercera_exploracion_sisat.findMany()
      * ```
      */
    get tercera_exploracion_sisat(): Prisma.tercera_exploracion_sisatDelegate<ExtArgs, {
        omit: OmitOpts;
    }>;
}
