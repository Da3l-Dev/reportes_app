...
exports.default = renderSisatOpEdu;
exports.renderMainView = renderMainView;
exports.renderDashboardExploracion = renderDashboardExploracion;
exports.renderGraficaGlobalSisat = renderGraficaGlobalSisat;
exports.renderTablaSisatOpEdu = renderTablaSisatOpEdu;
...
const DashboardExploracion_1 = __importDefault(require("./components/DashboardExploracion"));
const SisatSmartCharts_1 = __importDefault(require("./components/SisatSmartCharts"));
const TableSisatComparativo_1 = __importDefault(require("./components/TableSisatComparativo"));
/* =========================
   CONSTANTES
========================= */
...
function renderReportZona(dataZona, dataMapaZona, dataZonaPorEscuela) {
    ...
    return (0, server_1.renderToStaticMarkup)((0, jsx_runtime_1.jsxs)(ReportLayout_1.ReportLayout, { children: [(0, jsx_runtime_1.jsxs)("div", { className: "page page-break", children: [(0, jsx_runtime_1.jsx)(Header_1.default, { title: `REPORTE DE RESULTADOS ZONA ${dataZona[0].cct_zona}`, data: totalesHeader }), renderGraficas(dataZona)] }), (0, jsx_runtime_1.jsxs)("div", { className: "page table_page", children: [(0, jsx_runtime_1.jsxs)("p", { className: "notes", style: { marginTop: "10mm" }, children: [(0, jsx_runtime_1.jsx)("strong", { children: "Nota:" }), " Las presentes gr\u00E1ficas ilustran el universo total de estudiantes participantes de la zona ", dataZona[0].cct_zona, " ", "as\u00ED como la distribuci\u00F3n porcentual de los mismos seg\u00FAn sus niveles de integraci\u00F3n."] }), (0, jsx_runtime_1.jsxs)("p", { className: "notes", children: [(0, jsx_runtime_1.jsx)("strong", { children: "Notas:" }), " Los resultados que se presentan a continuaci\u00F3n est\u00E1n organizados por escuela y presentan, para cada grado y campo formativo, el nivel de integraci\u00F3n predominante, independientemente de que corresponda a niveles altos o bajos."] }), (0, jsx_runtime_1.jsx)("div", { style: { padding: "5mm 10mm" }, children: (0, jsx_runtime_1.jsx)(TablePorEscuela_1.TablePorEscuela, { dataMapaZona: dataMapaZona, dataZona: dataZonaPorEscuela }) })] })] }));
}
function renderReportSector(dataSector, dataEscuelas, dataZonaPorEscuela) {
    ...
    return (0, server_1.renderToStaticMarkup)((0, jsx_runtime_1.jsxs)(ReportLayout_1.ReportLayout, { children: [(0, jsx_runtime_1.jsxs)("div", { className: "page page-break", children: [(0, jsx_runtime_1.jsx)(Header_1.default, { title: `REPORTE DE RESULTADOS SECTOR ${dataSector[0].cct_sector}`, data: totalesHeader, isZona: false }), renderGraficas(dataSector)] }), (0, jsx_runtime_1.jsxs)("div", { className: "page page-break", children: [(0, jsx_runtime_1.jsxs)("p", { className: "notes", style: { marginTop: "10mm" }, children: [(0, jsx_runtime_1.jsx)("strong", { children: "Nota:" }), " Las presentes gr\u00E1ficas ilustran el universo total de estudiantes participantes del sector", " ", (0, jsx_runtime_1.jsx)("strong", { children: dataSector[0].cct_sector }), " as\u00ED como la distribuci\u00F3n porcentual de los mismos seg\u00FAn sus niveles de integraci\u00F3n."] }), (0, jsx_runtime_1.jsxs)("p", { className: "notes", children: [(0, jsx_runtime_1.jsx)("strong", { children: "Notas:" }), " Los resultados que se presentan a continuaci\u00F3n est\u00E1n organizados por escuela y presentan, para cada grado y campo formativo, el nivel de integraci\u00F3n predominante, independientemente de que corresponda a niveles altos o bajos."] }), (0, jsx_runtime_1.jsx)("div", { style: { marginTop: "10mm" }, children: (0, jsx_runtime_1.jsx)(TablePorEscuela_1.TablePorEscuela, { dataMapaZona: dataEscuelas, dataZona: dataZonaPorEscuela, agruparPorZona: true }) })] })] }));
}
...
async function renderOpcionEduReport(dataOpcion, dataEscuelas, dataZonaPorEscuela, totalesOpEdu) {
    const opcionEducativa = dataEscuelas[0]?.opcion_educativa || "opcion educativa";
    ...
    const escuelasParticipantesSet = new Set(dataZonaPorEscuela.map((item) => item.cct || item.cct_escuela));
    const totalEscuelasParticipantes = escuelasParticipantesSet.size;
    const formatearNumero = (num) => (num || 0).toLocaleString("es-MX");
    return (0, server_1.renderToStaticMarkup)((0, jsx_runtime_1.jsxs)(ReportLayout_1.ReportLayout, { children: [(0, jsx_runtime_1.jsxs)("div", { className: "page page-break", children: [(0, jsx_runtime_1.jsx)(Header_1.default, { title: `REPORTE DE RESULTADOS ${opcionPlural}`, data: [], isOpEdu: true, children: (0, jsx_runtime_1.jsxs)("div", { style: {
                                display: "flex",
                                justifyContent: "space-around",
                                width: "100%",
                                flexWrap: "wrap",
                                gap: "10px",
                            }, children: [(0, jsx_runtime_1.jsxs)("p", { children: ["Matr\u00EDcula Participante:", " ", formatearNumero(totalesOpEdu?.total_alumnos)] }), (0, jsx_runtime_1.jsxs)("p", { children: ["Escuelas participantes:", " ", formatearNumero(totalEscuelasParticipantes)] })] }) }), renderGraficas(dataOpcion), (0, jsx_runtime_1.jsxs)("p", { className: "notes", children: [(0, jsx_runtime_1.jsx)("strong", { children: "Nota:" }), " Las presentes gr\u00E1ficas ilustran el universo total de estudiantes participantes en la opci\u00F3n educativa", " ", (0, jsx_runtime_1.jsx)("strong", { children: opcionPlural }), ", as\u00ED como la distribuci\u00F3n porcentual de los mismos seg\u00FAn sus niveles de integraci\u00F3n."] })] }), (0, jsx_runtime_1.jsxs)("div", { className: "page page-break", children: [(0, jsx_runtime_1.jsxs)("p", { className: "notes", style: { marginTop: 10 }, children: [(0, jsx_runtime_1.jsx)("strong", { children: "Nota:" }), " Los resultados que se presentan a continuaci\u00F3n est\u00E1n organizados por escuela y presentan, para cada grado y campo formativo, el nivel de integraci\u00F3n predominante, independientemente de que corresponda a niveles altos o bajos."] }), (0, jsx_runtime_1.jsx)("div", { style: { marginTop: "10mm", padding: "0 10mm" }, children: (0, jsx_runtime_1.jsx)(TablePorEscuela_1.TablePorEscuela, { dataMapaZona: dataEscuelas, dataZona: dataZonaPorEscuela, agruparPorSector: true }) })] })] }));
}
async function renderEscuela(dataNiEscuela, dataGeneralEscuela, dataZona, dataAlumnosPrioritarios) {
    ...
    const primeraPagina = ((0, jsx_runtime_1.jsxs)("div", { className: "page page-break", style: {
            width: "100%",
            height: "100%",
        }, children: [(0, jsx_runtime_1.jsxs)(Header_1.default, { data: [], isOpEdu: true, title: ` REPORTE DE RESULTADOS ${dataGeneralEscuela[0].opcion_educativa}`, children: [(0, jsx_runtime_1.jsxs)("h4", { children: [dataGeneralEscuela[0].nombre, " ", dataGeneralEscuela[0].llave] }), (0, jsx_runtime_1.jsxs)("div", { style: {
                            display: "flex",
                            justifyContent: "space-around",
                            width: "100%",
                        }, children: [(0, jsx_runtime_1.jsxs)("p", { children: ["\uD83D\uDD5B TURNO: ", dataGeneralEscuela[0].turno] }), (0, jsx_runtime_1.jsxs)("p", { children: ["\uD83C\uDFE0 MUNICIPIO: ", dataGeneralEscuela[0].municipio] }), (0, jsx_runtime_1.jsxs)("p", { children: ["\uD83D\uDCCD LOCALIDAD: ", dataGeneralEscuela[0].localidad] }), (0, jsx_runtime_1.jsxs)("p", { children: ["MATRICULA PARTICIPANTE: ", dataGeneralEscuela[0]?.matricula ?? 0] })] })] }), renderGraficas(dataNiEscuela), (0, jsx_runtime_1.jsxs)("p", { className: "notes", children: [(0, jsx_runtime_1.jsx)("strong", { children: "Nota:" }), " Las presentes gr\u00E1ficas ilustran el universo total de estudiantes participantes a la escuela", " ", (0, jsx_runtime_1.jsx)("strong", { children: dataGeneralEscuela[0].nombre }), ", as\u00ED como la distribuci\u00F3n porcentual de los mismos seg\u00FAn sus niveles de integraci\u00F3n."] })] }, "primera-pagina"));
    // 🔥 NUEVA HOJA (SOLO AGREGADA, SIN TOCAR NADA)
    const paginaPrioridad = ((0, jsx_runtime_1.jsxs)("div", { className: "page page-break", style: { paddingTop: "10mm" }, children: [(0, jsx_runtime_1.jsxs)(Header_1.default, { data: [], isOpEdu: true, title: ` REPORTE DE RESULTADOS ${dataGeneralEscuela[0].opcion_educativa}`, children: [(0, jsx_runtime_1.jsxs)("h4", { children: [dataGeneralEscuela[0].nombre, " ", dataGeneralEscuela[0].llave] }), (0, jsx_runtime_1.jsxs)("div", { style: {
                            display: "flex",
                            justifyContent: "space-around",
                            width: "100%",
    ...
    if (tablaData.length === 0) {
        return (0, server_1.renderToStaticMarkup)((0, jsx_runtime_1.jsxs)(ReportLayout_1.ReportLayout, { children: [primeraPagina, (0, jsx_runtime_1.jsxs)("div", { className: "page", style: {
                        ...
                        paddingTop: "10mm",
                        marginBottom: "15mm",
                    }, children: [(0, jsx_runtime_1.jsx)(Header_1.default, { data: [], isOpEdu: true, title: ` REPORTE DE RESULTADOS ${dataGeneralEscuela[0].opcion_educativa}`, children: (0, jsx_runtime_1.jsxs)("div", { style: {
                                    display: "flex",
                                    justifyContent: "space-around",
                                    width: "100%",
                                ...
                                minHeight: 0,
                                        ...
                                        gridColumn: "1 / 2",
                                                ...
                                                margin: "0 0 5mm 0",
                                                fontSize: "12px",
                                            }, children: "Nivel de integraci\u00F3n a nivel zona" }), (0, jsx_runtime_1.jsx)("div", { children: dataZona[0] ? (renderGraficas(dataZona[0], 290, 250)) : ((0, jsx_runtime_1.jsx)("p", { style: { textAlign: "center", color: "#999" }, children: "Sin datos" })) })] }), (0, jsx_runtime_1.jsx)("div", { children: (0, jsx_runtime_1.jsx)(TablaRequiereAtencion_1.TablaRequiereAtencion, { data: dataNiEscuela, umbral: 30 }) })] })] }), paginaPrioridad] }));
    }
    ...
    for (let pageIndex = 0; pageIndex < totalPages; pageIndex++) {
        ...
        pages.push((0, jsx_runtime_1.jsxs)("div", { className: `page ${pageIndex < totalPages - 1 ? "page-break" : ""}`, style: {
                ...
                height: "100%",
                marginTop: "10mm",
            }, children: [(0, jsx_runtime_1.jsxs)(Header_1.default, { data: [], isOpEdu: true, title: ` REPORTE DE RESULTADOS ${dataGeneralEscuela[0].opcion_educativa}`, children: [(0, jsx_runtime_1.jsxs)("div", { style: {
                                display: "flex",
                                justifyContent: "space-around",
                                width: "100%",
                        ...
                        gap: "20px",
                                        ...
                                        margin: "0 0 5mm 0",
                                        fontSize: "12px",
                                    }, children: "Nivel de integraci\u00F3n a nivel zona" }), (0, jsx_runtime_1.jsxs)("div", { children: [dataZona[0] ? (renderGraficas(dataZona[0], 290, 250)) : ((0, jsx_runtime_1.jsx)("p", { style: { textAlign: "center", color: "#999" }, children: "Sin datos" })), (0, jsx_runtime_1.jsxs)("p", { className: "notes", style: { marginTop: "0mm" }, children: [(0, jsx_runtime_1.jsx)("strong", { children: "Nota:" }), " Estos resultados permiten analizar los niveles de integraci\u00F3n a nivel zona para que exista un contraste con la escuela."] })] })] })), (0, jsx_runtime_1.jsxs)("div", { children: [(0, jsx_runtime_1.jsxs)("p", { children: [(0, jsx_runtime_1.jsx)("strong", { children: "Nota: " }), "Los resultados se presentan por grado y campo formativo. El total corresponde al n\u00FAmero de alumnos por grado; sin embargo, un mismo alumno puede aparecer en m\u00E1s de un campo formativo. Por ello, los resultados deben interpretarse por grado."] }), (0, jsx_runtime_1.jsx)(TablaRequiereAtencion_1.TablaRequiereAtencion, { data: pageData, umbral: 30, showHeader: true, pageInfo: {
                                        current: pageIndex + 1,
                                        total: totalPages,
...
function renderSisatOpEdu(primeraExploracion = [], // 👈 Valor por defecto array vacío
segundaExploracion = [], // 👈 Valor por defecto array vacío
terceraExploracion = [], // 👈 NUEVO PARÁMETRO con valor por defecto
dataEscuelas = []) {
    // Obtener la opción educativa de la primera exploración si existe
    const opcionEducativa = primeraExploracion?.[0]?.opcion_educativa ||
    ...
    return (0, server_1.renderToStaticMarkup)((0, jsx_runtime_1.jsxs)(ReportLayout_1.ReportLayout, { children: [(0, jsx_runtime_1.jsx)(Header_1.default, { title: `REPORTE RESULTADOS SISAT ${opcionEducativa}`, data: [], isOpEdu: true, titleReport: "SISTEMA DE ALERTA TEMPRANA 2025-2026" }), (0, jsx_runtime_1.jsx)("div", { className: "page", children: (0, jsx_runtime_1.jsxs)("div", { style: {
                        display: "flex",
                        flexDirection: "column",
                        gap: "5mm",
                        justifyContent: "center",
                        alignItems: "center",
                                ...
                                flexWrap: "wrap",
                                        ...
                                        fontWeight: "bold",
                                                ...
                                                borderRadius: "3px",
                                            } }), (0, jsx_runtime_1.jsx)("span", { children: "NE: Niveles Esperados" })] }), (0, jsx_runtime_1.jsxs)("div", { style: {
                                        display: "flex",
                                        alignItems: "center",
                                        gap: "6px",
                                        fontSize: "12px",
                                        fontWeight: "bold",
                                                ...
                                                borderRadius: "3px",
                                            } }), (0, jsx_runtime_1.jsx)("span", { children: "ED: En Desarrollo" })] }), (0, jsx_runtime_1.jsxs)("div", { style: {
                                        display: "flex",
                                        alignItems: "center",
                                        gap: "6px",
                                        fontSize: "12px",
                                        fontWeight: "bold",
                                                ...
                                                borderRadius: "3px",
                                            } }), (0, jsx_runtime_1.jsx)("span", { children: "RA: Requiere Apoyo" })] })] }), (0, jsx_runtime_1.jsx)(SisatSmartCharts_1.default, { primera: primeraExploracion || [], segunda: segundaExploracion || [], tercera: terceraExploracion || [] })] }) }), (0, jsx_runtime_1.jsxs)("div", { className: "page", style: { paddingTop: "0px", marginTop: "0px" }, children: [(0, jsx_runtime_1.jsx)(Header_1.default, { data: [], title: `REPORTE RESULTADOS SISAT ${opcionEducativa}`, isOpEdu: true, titleReport: "SISTEMA DE ALERTA TEMPRANA 25-26" }), (0, jsx_runtime_1.jsx)(TableSisatComparativo_1.default, { primera: primeraExploracion || [], segunda: segundaExploracion || [], tercera: terceraExploracion || [], dataEscuelas: dataEscuelas || [] })] })] }));
}
...
async function renderDashboardExploracion() {
    return (0, server_1.renderToStaticMarkup)((0, jsx_runtime_1.jsx)(ReportLayout_1.ReportLayout, { children: (0, jsx_runtime_1.jsx)(DashboardExploracion_1.default, {}) }));
}
function renderGraficaGlobalSisat(primeraExploracion = [], segundaExploracion = [], terceraExploracion = []) {
    const opcionEducativa = primeraExploracion?.[0]?.opcion_educativa ||
        segundaExploracion?.[0]?.opcion_educativa ||
        terceraExploracion?.[0]?.opcion_educativa ||
        "OPCIÓN EDUCATIVA";
    return (0, server_1.renderToStaticMarkup)((0, jsx_runtime_1.jsxs)(ReportLayout_1.ReportLayout, { children: [(0, jsx_runtime_1.jsx)(Header_1.default, { title: `REPORTE RESULTADOS SISAT ${opcionEducativa}`, data: [], isOpEdu: true, titleReport: "SISTEMA DE ALERTA TEMPRANA 2025-2026" }), (0, jsx_runtime_1.jsx)("div", { className: "page", children: (0, jsx_runtime_1.jsxs)("div", { style: {
                        ...
                        alignItems: "center",
                                ...
                                gap: "15px",
                                flexWrap: "wrap",
                            }, children: [(0, jsx_runtime_1.jsxs)("div", { style: { display: "flex", alignItems: "center", gap: "6px", fontSize: "10px", fontWeight: "bold" }, children: [(0, jsx_runtime_1.jsx)("div", { style: { width: "10px", height: "10px", backgroundColor: "#369445", borderRadius: "3px" } }), (0, jsx_runtime_1.jsx)("span", { children: "NE: Niveles Esperados" })] }), (0, jsx_runtime_1.jsxs)("div", { style: { display: "flex", alignItems: "center", gap: "6px", fontSize: "10px", fontWeight: "bold" }, children: [(0, jsx_runtime_1.jsx)("div", { style: { width: "10px", height: "10px", backgroundColor: "#FACA58", borderRadius: "3px" } }), (0, jsx_runtime_1.jsx)("span", { children: "ED: En Desarrollo" })] }), (0, jsx_runtime_1.jsxs)("div", { style: { display: "flex", alignItems: "center", gap: "6px", fontSize: "10px", fontWeight: "bold" }, children: [(0, jsx_runtime_1.jsx)("div", { style: { width: "10px", height: "10px", backgroundColor: "#A71D27", borderRadius: "3px" } }), (0, jsx_runtime_1.jsx)("span", { children: "RA: Requiere Apoyo" })] })] }), (0, jsx_runtime_1.jsx)("div", { children: (0, jsx_runtime_1.jsx)(SisatSmartCharts_1.default, { primera: primeraExploracion, segunda: segundaExploracion, tercera: terceraExploracion }) })] }) })] }));
}
/* =========================
   SISAT - TABLA POR CHUNK (SOLO TABLA)
========================= */
function renderTablaSisatOpEdu(primeraExploracion = [], segundaExploracion = [], terceraExploracion = [], dataEscuelas = [], chunkIndex = 1, totalChunks = 1) {
    const opcionEducativa = primeraExploracion?.[0]?.opcion_educativa ||
        segundaExploracion?.[0]?.opcion_educativa ||
        terceraExploracion?.[0]?.opcion_educativa ||
        "OPCIÓN EDUCATIVA";
    const esUltimoChunk = chunkIndex === totalChunks;
    return (0, server_1.renderToStaticMarkup)((0, jsx_runtime_1.jsxs)(ReportLayout_1.ReportLayout, { children: [(0, jsx_runtime_1.jsx)(Header_1.default, { data: [], title: `REPORTE RESULTADOS SISAT ${opcionEducativa}`, isOpEdu: true, titleReport: "SISTEMA DE ALERTA TEMPRANA 25-26" }), (0, jsx_runtime_1.jsxs)("div", { className: esUltimoChunk ? "page" : "page page-break", style: {
                    paddingTop: "0px",
                    marginTop: "0px",
                    paddingBottom: "0px",
                    marginBottom: "0px",
                    height: "100%",
                            ...
                            marginBottom: "2px",
                            color: "#666"
                        }, children: ["Tabla - Chunk ", chunkIndex, " de ", totalChunks] }), (0, jsx_runtime_1.jsx)(TableSisatComparativo_1.default, { primera: primeraExploracion, segunda: segundaExploracion, tercera: terceraExploracion, dataEscuelas: dataEscuelas })] })] }));
}
