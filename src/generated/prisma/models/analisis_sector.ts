...
// @ts-nocheck 
/*
 * This file exports the `analisis_sector` model and its related types.
 *
...
export type GetAnalisis_sectorAggregateType<T extends Analisis_sectorAggregateArgs> = {
      [P in keyof T & keyof AggregateAnalisis_sector]: P extends '_count' | 'count'
    ? T[P] extends true
      ? number
      : Prisma.GetScalarType<T[P], AggregateAnalisis_sector[P]>
    : Prisma.GetScalarType<T[P], AggregateAnalisis_sector[P]>
}
...
type GetAnalisis_sectorGroupByPayload<T extends analisis_sectorGroupByArgs> = Prisma.PrismaPromise<
  Array<
    Prisma.PickEnumerable<Analisis_sectorGroupByOutputType, T['by']> &
      {
        [P in ((keyof T) & (keyof Analisis_sectorGroupByOutputType))]: P extends '_count'
          ? T[P] extends boolean
            ? number
            : Prisma.GetScalarType<T[P], Analisis_sectorGroupByOutputType[P]>
          : Prisma.GetScalarType<T[P], Analisis_sectorGroupByOutputType[P]>
      }
    >
  >
...
export type analisis_sectorCountArgs<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> =
  Omit<analisis_sectorFindManyArgs, 'select' | 'include' | 'distinct' | 'omit' | 'relationLoadStrategy'> & {
...
export interface analisis_sectorDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
  [K: symbol]: { types: Prisma.TypeMap<ExtArgs>['model']['analisis_sector'], meta: { name: 'analisis_sector' } }
  /**
   ...
   * })
  **/
  count<T extends analisis_sectorCountArgs>(
    args?: Prisma.Subset<T, analisis_sectorCountArgs>,
  ): Prisma.PrismaPromise<
    T extends runtime.Types.Utils.Record<'select', any>
      ? T['select'] extends true
        ? number
        : Prisma.GetScalarType<T['select'], Analisis_sectorCountAggregateOutputType>
      : number
  >
  ...
  **/
  groupBy<
    T extends analisis_sectorGroupByArgs,
  ...
  >(args: Prisma.SubsetIntersection<T, analisis_sectorGroupByArgs, OrderByArg> & InputErrors): {} extends InputErrors ? GetAnalisis_sectorGroupByPayload<T> : Prisma.PrismaPromise<InputErrors>
/**
