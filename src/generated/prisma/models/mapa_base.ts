...
// @ts-nocheck 
/*
 * This file exports the `mapa_base` model and its related types.
 *
...
export type GetMapa_baseAggregateType<T extends Mapa_baseAggregateArgs> = {
      [P in keyof T & keyof AggregateMapa_base]: P extends '_count' | 'count'
    ? T[P] extends true
      ? number
      : Prisma.GetScalarType<T[P], AggregateMapa_base[P]>
    : Prisma.GetScalarType<T[P], AggregateMapa_base[P]>
}
...
type GetMapa_baseGroupByPayload<T extends mapa_baseGroupByArgs> = Prisma.PrismaPromise<
  Array<
    Prisma.PickEnumerable<Mapa_baseGroupByOutputType, T['by']> &
      {
        [P in ((keyof T) & (keyof Mapa_baseGroupByOutputType))]: P extends '_count'
          ? T[P] extends boolean
            ? number
            : Prisma.GetScalarType<T[P], Mapa_baseGroupByOutputType[P]>
          : Prisma.GetScalarType<T[P], Mapa_baseGroupByOutputType[P]>
      }
    >
  >
...
export type mapa_baseCountArgs<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> =
  Omit<mapa_baseFindManyArgs, 'select' | 'include' | 'distinct' | 'omit' | 'relationLoadStrategy'> & {
...
export interface mapa_baseDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
  [K: symbol]: { types: Prisma.TypeMap<ExtArgs>['model']['mapa_base'], meta: { name: 'mapa_base' } }
  /**
   ...
   * })
  **/
  count<T extends mapa_baseCountArgs>(
    args?: Prisma.Subset<T, mapa_baseCountArgs>,
  ): Prisma.PrismaPromise<
    T extends runtime.Types.Utils.Record<'select', any>
      ? T['select'] extends true
        ? number
        : Prisma.GetScalarType<T['select'], Mapa_baseCountAggregateOutputType>
      : number
  >
  ...
  **/
  groupBy<
    T extends mapa_baseGroupByArgs,
  ...
  >(args: Prisma.SubsetIntersection<T, mapa_baseGroupByArgs, OrderByArg> & InputErrors): {} extends InputErrors ? GetMapa_baseGroupByPayload<T> : Prisma.PrismaPromise<InputErrors>
/**
