...
// @ts-nocheck 
/*
 * This file exports the `ni_opcion_educativa` model and its related types.
 *
...
export type GetNi_opcion_educativaAggregateType<T extends Ni_opcion_educativaAggregateArgs> = {
      [P in keyof T & keyof AggregateNi_opcion_educativa]: P extends '_count' | 'count'
    ? T[P] extends true
      ? number
      : Prisma.GetScalarType<T[P], AggregateNi_opcion_educativa[P]>
    : Prisma.GetScalarType<T[P], AggregateNi_opcion_educativa[P]>
}
...
type GetNi_opcion_educativaGroupByPayload<T extends ni_opcion_educativaGroupByArgs> = Prisma.PrismaPromise<
  Array<
    Prisma.PickEnumerable<Ni_opcion_educativaGroupByOutputType, T['by']> &
      {
        [P in ((keyof T) & (keyof Ni_opcion_educativaGroupByOutputType))]: P extends '_count'
          ? T[P] extends boolean
            ? number
            : Prisma.GetScalarType<T[P], Ni_opcion_educativaGroupByOutputType[P]>
          : Prisma.GetScalarType<T[P], Ni_opcion_educativaGroupByOutputType[P]>
      }
    >
  >
...
export type ni_opcion_educativaCountArgs<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> =
  Omit<ni_opcion_educativaFindManyArgs, 'select' | 'include' | 'distinct' | 'omit' | 'relationLoadStrategy'> & {
...
export interface ni_opcion_educativaDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
  [K: symbol]: { types: Prisma.TypeMap<ExtArgs>['model']['ni_opcion_educativa'], meta: { name: 'ni_opcion_educativa' } }
  /**
   ...
   * })
  **/
  count<T extends ni_opcion_educativaCountArgs>(
    args?: Prisma.Subset<T, ni_opcion_educativaCountArgs>,
  ): Prisma.PrismaPromise<
    T extends runtime.Types.Utils.Record<'select', any>
      ? T['select'] extends true
        ? number
        : Prisma.GetScalarType<T['select'], Ni_opcion_educativaCountAggregateOutputType>
      : number
  >
  ...
  **/
  groupBy<
    T extends ni_opcion_educativaGroupByArgs,
  ...
  >(args: Prisma.SubsetIntersection<T, ni_opcion_educativaGroupByArgs, OrderByArg> & InputErrors): {} extends InputErrors ? GetNi_opcion_educativaGroupByPayload<T> : Prisma.PrismaPromise<InputErrors>
/**
