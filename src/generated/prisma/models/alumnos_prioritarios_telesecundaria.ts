...
// @ts-nocheck 
/*
 * This file exports the `alumnos_prioritarios_telesecundaria` model and its related types.
 *
...
export type GetAlumnos_prioritarios_telesecundariaAggregateType<T extends Alumnos_prioritarios_telesecundariaAggregateArgs> = {
      [P in keyof T & keyof AggregateAlumnos_prioritarios_telesecundaria]: P extends '_count' | 'count'
    ? T[P] extends true
      ? number
      : Prisma.GetScalarType<T[P], AggregateAlumnos_prioritarios_telesecundaria[P]>
    : Prisma.GetScalarType<T[P], AggregateAlumnos_prioritarios_telesecundaria[P]>
}
...
type GetAlumnos_prioritarios_telesecundariaGroupByPayload<T extends alumnos_prioritarios_telesecundariaGroupByArgs> = Prisma.PrismaPromise<
  Array<
    Prisma.PickEnumerable<Alumnos_prioritarios_telesecundariaGroupByOutputType, T['by']> &
      {
        [P in ((keyof T) & (keyof Alumnos_prioritarios_telesecundariaGroupByOutputType))]: P extends '_count'
          ? T[P] extends boolean
            ? number
            : Prisma.GetScalarType<T[P], Alumnos_prioritarios_telesecundariaGroupByOutputType[P]>
          : Prisma.GetScalarType<T[P], Alumnos_prioritarios_telesecundariaGroupByOutputType[P]>
      }
    >
  >
...
export type alumnos_prioritarios_telesecundariaCountArgs<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> =
  Omit<alumnos_prioritarios_telesecundariaFindManyArgs, 'select' | 'include' | 'distinct' | 'omit' | 'relationLoadStrategy'> & {
...
export interface alumnos_prioritarios_telesecundariaDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
  [K: symbol]: { types: Prisma.TypeMap<ExtArgs>['model']['alumnos_prioritarios_telesecundaria'], meta: { name: 'alumnos_prioritarios_telesecundaria' } }
  /**
   ...
   * })
  **/
  count<T extends alumnos_prioritarios_telesecundariaCountArgs>(
    args?: Prisma.Subset<T, alumnos_prioritarios_telesecundariaCountArgs>,
  ): Prisma.PrismaPromise<
    T extends runtime.Types.Utils.Record<'select', any>
      ? T['select'] extends true
        ? number
        : Prisma.GetScalarType<T['select'], Alumnos_prioritarios_telesecundariaCountAggregateOutputType>
      : number
  >
  ...
  **/
  groupBy<
    T extends alumnos_prioritarios_telesecundariaGroupByArgs,
  ...
  >(args: Prisma.SubsetIntersection<T, alumnos_prioritarios_telesecundariaGroupByArgs, OrderByArg> & InputErrors): {} extends InputErrors ? GetAlumnos_prioritarios_telesecundariaGroupByPayload<T> : Prisma.PrismaPromise<InputErrors>
/**
