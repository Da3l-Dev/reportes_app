...
// @ts-nocheck 
/*
 * This file exports the `ni_zona` model and its related types.
 *
...
export type GetNi_zonaAggregateType<T extends Ni_zonaAggregateArgs> = {
      [P in keyof T & keyof AggregateNi_zona]: P extends '_count' | 'count'
    ? T[P] extends true
      ? number
      : Prisma.GetScalarType<T[P], AggregateNi_zona[P]>
    : Prisma.GetScalarType<T[P], AggregateNi_zona[P]>
}
...
type GetNi_zonaGroupByPayload<T extends ni_zonaGroupByArgs> = Prisma.PrismaPromise<
  Array<
    Prisma.PickEnumerable<Ni_zonaGroupByOutputType, T['by']> &
      {
        [P in ((keyof T) & (keyof Ni_zonaGroupByOutputType))]: P extends '_count'
          ? T[P] extends boolean
            ? number
            : Prisma.GetScalarType<T[P], Ni_zonaGroupByOutputType[P]>
          : Prisma.GetScalarType<T[P], Ni_zonaGroupByOutputType[P]>
      }
    >
  >
...
export type ni_zonaCountArgs<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> =
  Omit<ni_zonaFindManyArgs, 'select' | 'include' | 'distinct' | 'omit' | 'relationLoadStrategy'> & {
...
export interface ni_zonaDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
  [K: symbol]: { types: Prisma.TypeMap<ExtArgs>['model']['ni_zona'], meta: { name: 'ni_zona' } }
  /**
   ...
   * })
  **/
  count<T extends ni_zonaCountArgs>(
    args?: Prisma.Subset<T, ni_zonaCountArgs>,
  ): Prisma.PrismaPromise<
    T extends runtime.Types.Utils.Record<'select', any>
      ? T['select'] extends true
        ? number
        : Prisma.GetScalarType<T['select'], Ni_zonaCountAggregateOutputType>
      : number
  >
  ...
  **/
  ...
  >(args: Prisma.SubsetIntersection<T, ni_zonaGroupByArgs, OrderByArg> & InputErrors): {} extends InputErrors ? GetNi_zonaGroupByPayload<T> : Prisma.PrismaPromise<InputErrors>
/**
