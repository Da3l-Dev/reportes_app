...
// @ts-nocheck 
/*
 * This file exports the `alumnos_prioritarios_primaria_general` model and its related types.
 *
...
export type GetAlumnos_prioritarios_primaria_generalAggregateType<T extends Alumnos_prioritarios_primaria_generalAggregateArgs> = {
      [P in keyof T & keyof AggregateAlumnos_prioritarios_primaria_general]: P extends '_count' | 'count'
    ? T[P] extends true
      ? number
      : Prisma.GetScalarType<T[P], AggregateAlumnos_prioritarios_primaria_general[P]>
    : Prisma.GetScalarType<T[P], AggregateAlumnos_prioritarios_primaria_general[P]>
}
...
type GetAlumnos_prioritarios_primaria_generalGroupByPayload<T extends alumnos_prioritarios_primaria_generalGroupByArgs> = Prisma.PrismaPromise<
  Array<
    Prisma.PickEnumerable<Alumnos_prioritarios_primaria_generalGroupByOutputType, T['by']> &
      {
        [P in ((keyof T) & (keyof Alumnos_prioritarios_primaria_generalGroupByOutputType))]: P extends '_count'
          ? T[P] extends boolean
            ? number
            : Prisma.GetScalarType<T[P], Alumnos_prioritarios_primaria_generalGroupByOutputType[P]>
          : Prisma.GetScalarType<T[P], Alumnos_prioritarios_primaria_generalGroupByOutputType[P]>
      }
    >
  >
...
export type alumnos_prioritarios_primaria_generalCountArgs<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> =
  Omit<alumnos_prioritarios_primaria_generalFindManyArgs, 'select' | 'include' | 'distinct' | 'omit' | 'relationLoadStrategy'> & {
...
export interface alumnos_prioritarios_primaria_generalDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
  [K: symbol]: { types: Prisma.TypeMap<ExtArgs>['model']['alumnos_prioritarios_primaria_general'], meta: { name: 'alumnos_prioritarios_primaria_general' } }
  /**
  ...
  count<T extends alumnos_prioritarios_primaria_generalCountArgs>(
    ...
    T extends runtime.Types.Utils.Record<'select', any>
      ? T['select'] extends true
        ? number
        : Prisma.GetScalarType<T['select'], Alumnos_prioritarios_primaria_generalCountAggregateOutputType>
      : number
  >
  ...
  **/
  groupBy<
    T extends alumnos_prioritarios_primaria_generalGroupByArgs,
  ...
  >(args: Prisma.SubsetIntersection<T, alumnos_prioritarios_primaria_generalGroupByArgs, OrderByArg> & InputErrors): {} extends InputErrors ? GetAlumnos_prioritarios_primaria_generalGroupByPayload<T> : Prisma.PrismaPromise<InputErrors>
/**
