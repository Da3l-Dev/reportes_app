...
// @ts-nocheck 
/*
 * This file exports the `primera_exploracion_sisat` model and its related types.
 *
...
export type GetPrimera_exploracion_sisatAggregateType<T extends Primera_exploracion_sisatAggregateArgs> = {
      [P in keyof T & keyof AggregatePrimera_exploracion_sisat]: P extends '_count' | 'count'
    ? T[P] extends true
      ? number
      : Prisma.GetScalarType<T[P], AggregatePrimera_exploracion_sisat[P]>
    : Prisma.GetScalarType<T[P], AggregatePrimera_exploracion_sisat[P]>
}
...
type GetPrimera_exploracion_sisatGroupByPayload<T extends primera_exploracion_sisatGroupByArgs> = Prisma.PrismaPromise<
  Array<
    Prisma.PickEnumerable<Primera_exploracion_sisatGroupByOutputType, T['by']> &
      {
        [P in ((keyof T) & (keyof Primera_exploracion_sisatGroupByOutputType))]: P extends '_count'
          ? T[P] extends boolean
            ? number
            : Prisma.GetScalarType<T[P], Primera_exploracion_sisatGroupByOutputType[P]>
          : Prisma.GetScalarType<T[P], Primera_exploracion_sisatGroupByOutputType[P]>
      }
    >
  >
...
export type primera_exploracion_sisatCountArgs<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> =
  Omit<primera_exploracion_sisatFindManyArgs, 'select' | 'include' | 'distinct' | 'omit' | 'relationLoadStrategy'> & {
...
export interface primera_exploracion_sisatDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
  [K: symbol]: { types: Prisma.TypeMap<ExtArgs>['model']['primera_exploracion_sisat'], meta: { name: 'primera_exploracion_sisat' } }
  /**
   ...
   * })
  **/
  count<T extends primera_exploracion_sisatCountArgs>(
    args?: Prisma.Subset<T, primera_exploracion_sisatCountArgs>,
  ): Prisma.PrismaPromise<
    T extends runtime.Types.Utils.Record<'select', any>
      ? T['select'] extends true
        ? number
        : Prisma.GetScalarType<T['select'], Primera_exploracion_sisatCountAggregateOutputType>
      : number
  >
  ...
  **/
  groupBy<
    T extends primera_exploracion_sisatGroupByArgs,
  ...
  >(args: Prisma.SubsetIntersection<T, primera_exploracion_sisatGroupByArgs, OrderByArg> & InputErrors): {} extends InputErrors ? GetPrimera_exploracion_sisatGroupByPayload<T> : Prisma.PrismaPromise<InputErrors>
/**
