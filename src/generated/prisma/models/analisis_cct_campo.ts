...
// @ts-nocheck 
/*
 * This file exports the `analisis_cct_campo` model and its related types.
 *
...
export type GetAnalisis_cct_campoAggregateType<T extends Analisis_cct_campoAggregateArgs> = {
      [P in keyof T & keyof AggregateAnalisis_cct_campo]: P extends '_count' | 'count'
    ? T[P] extends true
      ? number
      : Prisma.GetScalarType<T[P], AggregateAnalisis_cct_campo[P]>
    : Prisma.GetScalarType<T[P], AggregateAnalisis_cct_campo[P]>
}
...
type GetAnalisis_cct_campoGroupByPayload<T extends analisis_cct_campoGroupByArgs> = Prisma.PrismaPromise<
  Array<
    Prisma.PickEnumerable<Analisis_cct_campoGroupByOutputType, T['by']> &
      {
        [P in ((keyof T) & (keyof Analisis_cct_campoGroupByOutputType))]: P extends '_count'
          ? T[P] extends boolean
            ? number
            : Prisma.GetScalarType<T[P], Analisis_cct_campoGroupByOutputType[P]>
          : Prisma.GetScalarType<T[P], Analisis_cct_campoGroupByOutputType[P]>
      }
    >
  >
...
export type analisis_cct_campoCountArgs<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> =
  Omit<analisis_cct_campoFindManyArgs, 'select' | 'include' | 'distinct' | 'omit' | 'relationLoadStrategy'> & {
...
export interface analisis_cct_campoDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
  [K: symbol]: { types: Prisma.TypeMap<ExtArgs>['model']['analisis_cct_campo'], meta: { name: 'analisis_cct_campo' } }
  /**
   ...
   * })
  **/
  count<T extends analisis_cct_campoCountArgs>(
    args?: Prisma.Subset<T, analisis_cct_campoCountArgs>,
  ): Prisma.PrismaPromise<
    T extends runtime.Types.Utils.Record<'select', any>
      ? T['select'] extends true
        ? number
        : Prisma.GetScalarType<T['select'], Analisis_cct_campoCountAggregateOutputType>
      : number
  >
  ...
  **/
  groupBy<
    T extends analisis_cct_campoGroupByArgs,
  ...
  >(args: Prisma.SubsetIntersection<T, analisis_cct_campoGroupByArgs, OrderByArg> & InputErrors): {} extends InputErrors ? GetAnalisis_cct_campoGroupByPayload<T> : Prisma.PrismaPromise<InputErrors>
/**
