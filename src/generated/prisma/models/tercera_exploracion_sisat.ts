...
// @ts-nocheck 
/*
 * This file exports the `tercera_exploracion_sisat` model and its related types.
 *
...
export type GetTercera_exploracion_sisatAggregateType<T extends Tercera_exploracion_sisatAggregateArgs> = {
      [P in keyof T & keyof AggregateTercera_exploracion_sisat]: P extends '_count' | 'count'
    ? T[P] extends true
      ? number
      : Prisma.GetScalarType<T[P], AggregateTercera_exploracion_sisat[P]>
    : Prisma.GetScalarType<T[P], AggregateTercera_exploracion_sisat[P]>
}
...
type GetTercera_exploracion_sisatGroupByPayload<T extends tercera_exploracion_sisatGroupByArgs> = Prisma.PrismaPromise<
  Array<
    Prisma.PickEnumerable<Tercera_exploracion_sisatGroupByOutputType, T['by']> &
      {
        [P in ((keyof T) & (keyof Tercera_exploracion_sisatGroupByOutputType))]: P extends '_count'
          ? T[P] extends boolean
            ? number
            : Prisma.GetScalarType<T[P], Tercera_exploracion_sisatGroupByOutputType[P]>
          : Prisma.GetScalarType<T[P], Tercera_exploracion_sisatGroupByOutputType[P]>
      }
    >
  >
...
export type tercera_exploracion_sisatCountArgs<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> =
  Omit<tercera_exploracion_sisatFindManyArgs, 'select' | 'include' | 'distinct' | 'omit' | 'relationLoadStrategy'> & {
...
export interface tercera_exploracion_sisatDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
  [K: symbol]: { types: Prisma.TypeMap<ExtArgs>['model']['tercera_exploracion_sisat'], meta: { name: 'tercera_exploracion_sisat' } }
  /**
   ...
   * })
  **/
  count<T extends tercera_exploracion_sisatCountArgs>(
    args?: Prisma.Subset<T, tercera_exploracion_sisatCountArgs>,
  ): Prisma.PrismaPromise<
    T extends runtime.Types.Utils.Record<'select', any>
      ? T['select'] extends true
        ? number
        : Prisma.GetScalarType<T['select'], Tercera_exploracion_sisatCountAggregateOutputType>
      : number
  >
  ...
  **/
  groupBy<
    T extends tercera_exploracion_sisatGroupByArgs,
  ...
  >(args: Prisma.SubsetIntersection<T, tercera_exploracion_sisatGroupByArgs, OrderByArg> & InputErrors): {} extends InputErrors ? GetTercera_exploracion_sisatGroupByPayload<T> : Prisma.PrismaPromise<InputErrors>
/**
