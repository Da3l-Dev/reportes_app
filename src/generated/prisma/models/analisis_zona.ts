...
// @ts-nocheck 
/*
 * This file exports the `analisis_zona` model and its related types.
 *
...
export type GetAnalisis_zonaAggregateType<T extends Analisis_zonaAggregateArgs> = {
      [P in keyof T & keyof AggregateAnalisis_zona]: P extends '_count' | 'count'
    ? T[P] extends true
      ? number
      : Prisma.GetScalarType<T[P], AggregateAnalisis_zona[P]>
    : Prisma.GetScalarType<T[P], AggregateAnalisis_zona[P]>
}
...
type GetAnalisis_zonaGroupByPayload<T extends analisis_zonaGroupByArgs> = Prisma.PrismaPromise<
  Array<
    Prisma.PickEnumerable<Analisis_zonaGroupByOutputType, T['by']> &
      {
        [P in ((keyof T) & (keyof Analisis_zonaGroupByOutputType))]: P extends '_count'
          ? T[P] extends boolean
            ? number
            : Prisma.GetScalarType<T[P], Analisis_zonaGroupByOutputType[P]>
          : Prisma.GetScalarType<T[P], Analisis_zonaGroupByOutputType[P]>
      }
    >
  >
...
export type analisis_zonaCountArgs<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> =
  Omit<analisis_zonaFindManyArgs, 'select' | 'include' | 'distinct' | 'omit' | 'relationLoadStrategy'> & {
...
export interface analisis_zonaDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
  [K: symbol]: { types: Prisma.TypeMap<ExtArgs>['model']['analisis_zona'], meta: { name: 'analisis_zona' } }
  /**
   ...
   * })
  **/
  count<T extends analisis_zonaCountArgs>(
    args?: Prisma.Subset<T, analisis_zonaCountArgs>,
  ): Prisma.PrismaPromise<
    T extends runtime.Types.Utils.Record<'select', any>
      ? T['select'] extends true
        ? number
        : Prisma.GetScalarType<T['select'], Analisis_zonaCountAggregateOutputType>
      : number
  >
  ...
  **/
  groupBy<
    T extends analisis_zonaGroupByArgs,
  ...
  >(args: Prisma.SubsetIntersection<T, analisis_zonaGroupByArgs, OrderByArg> & InputErrors): {} extends InputErrors ? GetAnalisis_zonaGroupByPayload<T> : Prisma.PrismaPromise<InputErrors>
/**
