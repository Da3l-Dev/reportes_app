...
// @ts-nocheck 
/*
 * This file exports the `supervisores` model and its related types.
 *
...
export type GetSupervisoresAggregateType<T extends SupervisoresAggregateArgs> = {
      [P in keyof T & keyof AggregateSupervisores]: P extends '_count' | 'count'
    ? T[P] extends true
      ? number
      : Prisma.GetScalarType<T[P], AggregateSupervisores[P]>
    : Prisma.GetScalarType<T[P], AggregateSupervisores[P]>
}
...
type GetSupervisoresGroupByPayload<T extends supervisoresGroupByArgs> = Prisma.PrismaPromise<
  Array<
    Prisma.PickEnumerable<SupervisoresGroupByOutputType, T['by']> &
      {
        [P in ((keyof T) & (keyof SupervisoresGroupByOutputType))]: P extends '_count'
          ? T[P] extends boolean
            ? number
            : Prisma.GetScalarType<T[P], SupervisoresGroupByOutputType[P]>
          : Prisma.GetScalarType<T[P], SupervisoresGroupByOutputType[P]>
      }
    >
  >
...
export type supervisoresCountArgs<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> =
  Omit<supervisoresFindManyArgs, 'select' | 'include' | 'distinct' | 'omit' | 'relationLoadStrategy'> & {
...
export interface supervisoresDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
  [K: symbol]: { types: Prisma.TypeMap<ExtArgs>['model']['supervisores'], meta: { name: 'supervisores' } }
  /**
   ...
   * })
  **/
  count<T extends supervisoresCountArgs>(
    args?: Prisma.Subset<T, supervisoresCountArgs>,
  ): Prisma.PrismaPromise<
    T extends runtime.Types.Utils.Record<'select', any>
      ? T['select'] extends true
        ? number
        : Prisma.GetScalarType<T['select'], SupervisoresCountAggregateOutputType>
      : number
  >
  ...
  **/
  groupBy<
    T extends supervisoresGroupByArgs,
  ...
  >(args: Prisma.SubsetIntersection<T, supervisoresGroupByArgs, OrderByArg> & InputErrors): {} extends InputErrors ? GetSupervisoresGroupByPayload<T> : Prisma.PrismaPromise<InputErrors>
/**
