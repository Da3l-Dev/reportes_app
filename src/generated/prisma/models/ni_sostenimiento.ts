...
// @ts-nocheck 
/*
 * This file exports the `ni_sostenimiento` model and its related types.
 *
...
export type GetNi_sostenimientoAggregateType<T extends Ni_sostenimientoAggregateArgs> = {
      [P in keyof T & keyof AggregateNi_sostenimiento]: P extends '_count' | 'count'
    ? T[P] extends true
      ? number
      : Prisma.GetScalarType<T[P], AggregateNi_sostenimiento[P]>
    : Prisma.GetScalarType<T[P], AggregateNi_sostenimiento[P]>
}
...
type GetNi_sostenimientoGroupByPayload<T extends ni_sostenimientoGroupByArgs> = Prisma.PrismaPromise<
  Array<
    Prisma.PickEnumerable<Ni_sostenimientoGroupByOutputType, T['by']> &
      {
        [P in ((keyof T) & (keyof Ni_sostenimientoGroupByOutputType))]: P extends '_count'
          ? T[P] extends boolean
            ? number
            : Prisma.GetScalarType<T[P], Ni_sostenimientoGroupByOutputType[P]>
          : Prisma.GetScalarType<T[P], Ni_sostenimientoGroupByOutputType[P]>
      }
    >
  >
...
export type ni_sostenimientoCountArgs<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> =
  Omit<ni_sostenimientoFindManyArgs, 'select' | 'include' | 'distinct' | 'omit' | 'relationLoadStrategy'> & {
...
export interface ni_sostenimientoDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
  [K: symbol]: { types: Prisma.TypeMap<ExtArgs>['model']['ni_sostenimiento'], meta: { name: 'ni_sostenimiento' } }
  /**
   ...
   * })
  **/
  count<T extends ni_sostenimientoCountArgs>(
    args?: Prisma.Subset<T, ni_sostenimientoCountArgs>,
  ): Prisma.PrismaPromise<
    T extends runtime.Types.Utils.Record<'select', any>
      ? T['select'] extends true
        ? number
        : Prisma.GetScalarType<T['select'], Ni_sostenimientoCountAggregateOutputType>
      : number
  >
  ...
  **/
  groupBy<
    T extends ni_sostenimientoGroupByArgs,
  ...
  >(args: Prisma.SubsetIntersection<T, ni_sostenimientoGroupByArgs, OrderByArg> & InputErrors): {} extends InputErrors ? GetNi_sostenimientoGroupByPayload<T> : Prisma.PrismaPromise<InputErrors>
/**
