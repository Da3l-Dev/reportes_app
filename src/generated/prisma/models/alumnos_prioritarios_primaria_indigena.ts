...
// @ts-nocheck 
/*
 * This file exports the `alumnos_prioritarios_primaria_indigena` model and its related types.
 *
...
export type GetAlumnos_prioritarios_primaria_indigenaAggregateType<T extends Alumnos_prioritarios_primaria_indigenaAggregateArgs> = {
      [P in keyof T & keyof AggregateAlumnos_prioritarios_primaria_indigena]: P extends '_count' | 'count'
    ? T[P] extends true
      ? number
      : Prisma.GetScalarType<T[P], AggregateAlumnos_prioritarios_primaria_indigena[P]>
    : Prisma.GetScalarType<T[P], AggregateAlumnos_prioritarios_primaria_indigena[P]>
}
...
type GetAlumnos_prioritarios_primaria_indigenaGroupByPayload<T extends alumnos_prioritarios_primaria_indigenaGroupByArgs> = Prisma.PrismaPromise<
  Array<
    Prisma.PickEnumerable<Alumnos_prioritarios_primaria_indigenaGroupByOutputType, T['by']> &
      {
        [P in ((keyof T) & (keyof Alumnos_prioritarios_primaria_indigenaGroupByOutputType))]: P extends '_count'
          ? T[P] extends boolean
            ? number
            : Prisma.GetScalarType<T[P], Alumnos_prioritarios_primaria_indigenaGroupByOutputType[P]>
          : Prisma.GetScalarType<T[P], Alumnos_prioritarios_primaria_indigenaGroupByOutputType[P]>
      }
    >
  >
...
export type alumnos_prioritarios_primaria_indigenaCountArgs<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> =
  Omit<alumnos_prioritarios_primaria_indigenaFindManyArgs, 'select' | 'include' | 'distinct' | 'omit' | 'relationLoadStrategy'> & {
...
export interface alumnos_prioritarios_primaria_indigenaDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
  [K: symbol]: { types: Prisma.TypeMap<ExtArgs>['model']['alumnos_prioritarios_primaria_indigena'], meta: { name: 'alumnos_prioritarios_primaria_indigena' } }
  /**
  ...
  **/
  count<T extends alumnos_prioritarios_primaria_indigenaCountArgs>(
    args?: Prisma.Subset<T, alumnos_prioritarios_primaria_indigenaCountArgs>,
  ): Prisma.PrismaPromise<
    T extends runtime.Types.Utils.Record<'select', any>
      ? T['select'] extends true
        ? number
        : Prisma.GetScalarType<T['select'], Alumnos_prioritarios_primaria_indigenaCountAggregateOutputType>
      : number
  >
  ...
  **/
  groupBy<
    T extends alumnos_prioritarios_primaria_indigenaGroupByArgs,
  ...
  >(args: Prisma.SubsetIntersection<T, alumnos_prioritarios_primaria_indigenaGroupByArgs, OrderByArg> & InputErrors): {} extends InputErrors ? GetAlumnos_prioritarios_primaria_indigenaGroupByPayload<T> : Prisma.PrismaPromise<InputErrors>
/**
