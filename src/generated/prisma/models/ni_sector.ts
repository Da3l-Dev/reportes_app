...
// @ts-nocheck 
/*
 * This file exports the `ni_sector` model and its related types.
 *
...
export type GetNi_sectorAggregateType<T extends Ni_sectorAggregateArgs> = {
      [P in keyof T & keyof AggregateNi_sector]: P extends '_count' | 'count'
    ? T[P] extends true
      ? number
      : Prisma.GetScalarType<T[P], AggregateNi_sector[P]>
    : Prisma.GetScalarType<T[P], AggregateNi_sector[P]>
}
...
type GetNi_sectorGroupByPayload<T extends ni_sectorGroupByArgs> = Prisma.PrismaPromise<
  Array<
    Prisma.PickEnumerable<Ni_sectorGroupByOutputType, T['by']> &
      {
        [P in ((keyof T) & (keyof Ni_sectorGroupByOutputType))]: P extends '_count'
          ? T[P] extends boolean
            ? number
            : Prisma.GetScalarType<T[P], Ni_sectorGroupByOutputType[P]>
          : Prisma.GetScalarType<T[P], Ni_sectorGroupByOutputType[P]>
      }
    >
  >
...
export type ni_sectorCountArgs<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> =
  Omit<ni_sectorFindManyArgs, 'select' | 'include' | 'distinct' | 'omit' | 'relationLoadStrategy'> & {
...
export interface ni_sectorDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
  [K: symbol]: { types: Prisma.TypeMap<ExtArgs>['model']['ni_sector'], meta: { name: 'ni_sector' } }
  /**
   ...
   * })
  **/
  count<T extends ni_sectorCountArgs>(
    args?: Prisma.Subset<T, ni_sectorCountArgs>,
  ): Prisma.PrismaPromise<
    T extends runtime.Types.Utils.Record<'select', any>
      ? T['select'] extends true
        ? number
        : Prisma.GetScalarType<T['select'], Ni_sectorCountAggregateOutputType>
      : number
  >
  ...
  **/
  groupBy<
    T extends ni_sectorGroupByArgs,
  ...
  >(args: Prisma.SubsetIntersection<T, ni_sectorGroupByArgs, OrderByArg> & InputErrors): {} extends InputErrors ? GetNi_sectorGroupByPayload<T> : Prisma.PrismaPromise<InputErrors>
/**
