        ...
        return ((0, jsx_runtime_1.jsxs)("table", { style: {
                ...
                border: "2px solid #000",
                                        ...
                                        color: "white",
                                            ...
                                            gap: "20px",
                                            flexWrap: "wrap",
                                        }, children: [(0, jsx_runtime_1.jsxs)("div", { children: ["JEFE ZONA:", " ", (0, jsx_runtime_1.jsx)("strong", { children: agrupado[zona]?.[0]?.nombre_sup_zona ?? "NO ASIGNADO" })] }), (0, jsx_runtime_1.jsxs)("div", { children: ["Zona: ", (0, jsx_runtime_1.jsx)("strong", { children: zona })] }), (0, jsx_runtime_1.jsxs)("div", { children: ["Opcion Educativa:", " ", (0, jsx_runtime_1.jsx)("strong", { children: agrupado[zona]?.[0]?.opcion_educativa ?? "Sin opción" })] }), (0, jsx_runtime_1.jsxs)("div", { children: ["No. Zona:", " ", (0, jsx_runtime_1.jsx)("strong", { children: agrupado[zona]?.[0]?.zona ?? "Sin número" })] })] }) }) }), agrupado[zona].map((escuela) => renderEscuela(escuela, dataZona))] }, zona))) })] }));
    }
    // Sin agrupación
    return ((0, jsx_runtime_1.jsxs)("table", { style: {
            width: "100%",
